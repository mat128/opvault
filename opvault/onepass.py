...
class OnePass:
    ...
    def unlock(self, master_password):
        salt = bytes(base64.b64decode(self._profile_json['salt']))
        iterations = self._profile_json['iterations']

        key, mac_key = self._derive_keys(bytes(master_password, 'ascii'), salt, iterations)
    ...
    def master_keys(self, derived_key, derived_mac_key):
        encrypted = base64.b64decode(self._profile_json['masterKey'])

        return self.decrypt_keys(encrypted, derived_key, derived_mac_key)

    def overview_keys(self, derived_key, derived_mac_key):
        encrypted = base64.b64decode(self._profile_json['overviewKey'])
    ...
    def item_keys(self, item):
        item_key = base64.b64decode(item['k'])
    ...
    def item_overview(self, item):
        overview_data = base64.b64decode(item['o'])
